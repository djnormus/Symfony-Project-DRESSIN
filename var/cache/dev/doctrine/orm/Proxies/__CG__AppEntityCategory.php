...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'product', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'subCategory', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'promo'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSubCategory(?\App\Entity\SubCategory $subCategory): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function setPromo(?\App\Entity\Promo $promo): \App\Entity\Category
    {
