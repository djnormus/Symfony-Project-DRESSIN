...
class __TwigTemplate_83bdd73ff4affbcb699cc953f84f9fe593c70f88f2e648016355eb0404a4c6cc extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container col-lg-6 pb-5\">
    <form action=\"";
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("finalReset");
        echo "\" method=\"post\">
        <div class=\"mb-3\">
            ...
            <input name=\"password\" type=\"password\" class=\"form-control\" id=\"exampleInputEmail1\"
                aria-describedby=\"emailHelp\" placeholder=\"Saisissez votre email\">
        </div>
        <div class=\"mb-3\">
...
";
    ...
    {
        return array (  132 => 29,  118 => 17,  114 => 15,  104 => 14,  93 => 10,  83 => 9,  70 => 5,  60 => 4,  37 => 1,);
    }
...
<div class=\"container col-lg-6 pb-5\">
    <form action=\"{{ path('finalReset') }}\" method=\"post\">
        <div class=\"mb-3\">
            <label for=\"exampleInputEmail1\" class=\"form-label\">Nouveau mot de passe</label>
            <input name=\"password\" type=\"password\" class=\"form-control\" id=\"exampleInputEmail1\"
                aria-describedby=\"emailHelp\" placeholder=\"Saisissez votre email\">
        ...
        {# input en type hidden, récupération de la variable id de user #}
...
{% endblock %}", "security/resetPassword.html.twig", "/Users/nounou/Desktop/Cours_doranco/14-cours_Symfony/projet_ecommerce/DressIn/templates/security/resetPassword.html.twig");
    }
}
